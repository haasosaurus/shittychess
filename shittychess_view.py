...
class ShittyView:
    ...
    def __init__(self, screen: pygame.Surface) -> NoReturn:
        """constructor"""
    ...
    def __load_image(self, img_path: Union[PathLike, str]) -> pygame.image:
        ...
        return pygame.image.load(img_path if isinstance(img_path, str) else str(img_path))

    def load_images(self, width: int, height: int) -> NoReturn:
